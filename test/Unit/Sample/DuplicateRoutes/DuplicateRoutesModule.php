...
use Modular\Router\Test\Unit\Sample\LibraryA\LibraryAFeatureBHandler;
...
final class DuplicateRoutesModule implements PowerModule, HasRoutes
{
    public function register(ConfigurableContainerInterface $container): void
    {
        ...
        $container->set(LibraryAFeatureBHandler::class, LibraryAFeatureBHandler::class);
    }
    ...
    public function getRoutes(): array
    {
        return [
            ...
            Route::get('/users', LibraryAFeatureBHandler::class),
        ];
    }
}
